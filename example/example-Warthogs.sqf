...
class CfgEditorSubcategories { // these categories under
  ...
  class gh_units_cars // Category class, you point to it in editorSubcategory
                      // property
  {
...
class CfgVehicles {
  // imports the OPTRE_M12_LRV from OPTREmod(this is going to be used as a
  // refrence for our new vehical(anything we dont add useing this will be
  // inherited from this vehicals includeing all the things that the))
  class OPTRE_M12_LRV;
  ...
  class ARMCO_M12_LRV : OPTRE_M12_LRV {
    ...
    side = 1;                                     // = BLUFOR/west
    scope = 2; // Scope is used to limit access to the class in the Mission
               // Editor(2 = public)
    crew =
        "ARMCO_Soldier_O_Phoenix";  // the unit that will acupy the vehicalslot
    faction = "ARMCO_PMC";          // the faction its apart of
    editorCategory = "armco_units"; // these 2 are what category it goes into
    editorSubcategory =
        "armco_units_cars"; // what the Category this goes in the editorCategory
    hiddenSelectionsTextures[] = // These textures are what will allways be used
                                 // as the basis
    ...
    class textureSources // These are defined texture grouped by class
    {
      ...
      class colornight {
        ...
        textures[] = {
            "\OPTRE_Vehicles\Warthog\data\night\M12HogMaav_extupper_night_co."
            "paa",
            "\OPTRE_Vehicles\Warthog\data\night\M12HogMaav_extunder_night_co."
            "paa",
      ...
      class colorwood {
        ...
        author = "Article 2 Studios";
        textures[] = {
            "\OPTRE_Vehicles\Warthog\data\woodland\M12HogMaav_extupper_wood_co."
            "paa",
            "\OPTRE_Vehicles\Warthog\data\woodland\M12HogMaav_extunder_wood_co."
            "paa",
    ...
    textureList[] = {
        ...
        "colorarmcot",
        1};
    // TFar Related stuff id just copy all of this as is and not change it
    // unless you understand whats happening
