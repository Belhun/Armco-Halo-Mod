...
class CfgCloudlets
{
	...
	class WNZ_TaserExp: Default
	{
		...
		onTimerScript="";
		beforeDestroyScript="\armco_ammo\scripts\unco.sqf";
		lifeTimeVar=0;
	...
	class WNZ_TaserExp_Big: Default
	{
		...
		randomDirectionIntensity=0.079999998;
		onTimerScript="";
		beforeDestroyScript="\armco_ammo\scripts\uncoAoE.sqf";
		lifeTimeVar=0;
		rotationVelocityVar=1;
		sizeVar=0;
		randomDirectionPeriodVar=2;
