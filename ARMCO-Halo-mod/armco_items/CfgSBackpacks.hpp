...
class ARMCO_Rucksack_tSoft_Alpha : ARMCO_PMC_UNSC_Rucksack {
  dlc = "ARMCO_PMC";
  author = "Belhun";
...
class ARMCO_Rucksack_tSoft_Sabre : ARMCO_PMC_UNSC_Rucksack {
  dlc = "ARMCO_PMC";
  author = "Belhun";
...
class ARMCO_Rucksack_tSoft_Zulu : ARMCO_PMC_UNSC_Rucksack {
  dlc = "ARMCO_PMC";
  author = "Belhun";
...
class ARMCO_Rucksack_tSoft_Phoenix : ARMCO_PMC_UNSC_Rucksack {
  dlc = "ARMCO_PMC";
  author = "Belhun";
...
class ARMCO_Rucksack_tSoft_Medical : ARMCO_PMC_UNSC_Rucksack {
  dlc = "ARMCO_PMC";
  author = "Belhun";
