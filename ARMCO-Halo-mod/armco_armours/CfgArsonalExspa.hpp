    ...
    class CfgWeapons
    {
        ...
        class ARMCO_Custom_BDU
		{
			...
			class Custom
			{
				...
				class Digital_Dark_Woodland
				{
					label="Digital Dark Woodland";
				};
				class Digital_Woodland
				{
