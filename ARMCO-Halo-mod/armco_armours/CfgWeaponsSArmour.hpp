...
*/
	...
	//removed A_Base, A_ChestArmor, A_ShinArmorLeft, A_ShinArmorRight, A_ThighArmorLeft, A_ThighArmorRight
	...
	//Alpha Base Armour AS_LargeLeft, AS_MediumRight, AP_AR, AP_Smoke, AP_Pistol, AP_Pack, A_KneesMarRight, A_KneesMarLeft, AP_Thigh, APO_Knife
	...
	//Alpha 
	//Sabre Base Armour AS_MediumLeft,AS_SmallRight,AP_BR,AP_Smoke,AP_Frag, No Upper Chest Add-on, A_KneesMarRight, A_KneesMarLeft, AP_Thigh, APO_Knife
	...
	//Zulu Base Armour AS_MediumLeft,AS_MediumRight,AP_BR,AP_Smoke,AP_Pistol,AP_Pack,A_KneesMarRight,AP_Rounds, APO_Knife
	...
	//Phoenix Base Armour AS_LargeLeft,AS_MediumRight,AP_BR,AP_Canteen,AP_Frag,AP_SG,A_KneesMarRight, A_KneesMarLeft,AP_MGThigh, APO_Knife
