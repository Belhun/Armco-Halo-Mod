...
class CfgVehicles {
  ...
  class C_R_M914_RV : OPTRE_M914_RV {
    ...
    hiddenSelections[] = {"camo1",     "camo2",       "clan",
                          "clan_text", "insignia",    "attach_apc",
                          "attach_mg", "attach_troop"};
    hiddenSelectionsTextures[] = {
        "custom_emergency\data\medical\warthog\Warthog_CR_black_clean_co.paa"};
    editorCategory = "colonial_administration";
    editorSubcategory = "c_rescue_v";
  ...
  class ARMCO_Kitbag_Firefighter : B_Kitbag_base {
    ...
    picture =
        "\A3\weapons_f\ammoboxes\bags\data\ui\icon_B_C_Compact_dgtl_ca.paa";
    hiddenSelectionsTextures[] = {
        "custom_emergency\data\firefighter\backpack\b_colonial_firefighter_ soft_co.paa"};
    maximumLoad = 350;
    mass = 20;
  };
...
class cfgWeapons {
  ...
  class ARMCO_CH252_Helmet_Firefighter : OPTRE_UNSC_CH252_Helmet_Base {
    ...
    hiddenSelectionsTextures[] = {
        ...
        "custom_emergency\data\firefighter\helmet\h_visor_colonial_firefighter_ co.paa",
        "optre_unsc_units\army\data\ghillie_woodland_co.paa"};
    subItems[] = {
        "Integrated_NVG_TI_0_F",
    };
