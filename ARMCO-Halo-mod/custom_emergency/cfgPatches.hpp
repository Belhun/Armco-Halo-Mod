class CfgPatches {
  class CA_ARMCO_ADMIN {
    units[] = {
        // Police Units//
        "ARMCO_Police_Officer", "ARMCO_Police_Officer_tl", "C_P_M12_FAV",

        // Rescue Units//
        "ARMCO_Rescue_Officer", "ARMCO_Rescue_Officer_tl", "C_P_M12_LRV",
        "C_R_M12_FAV", "C_R_M914_RV", "C_R_M12_Medical",

        // Firefighter Units//
        "ARMCO_Firefighter_Officer", "ARMCO_Firefighter_Officer_tl",
        "C_F_M12_RRV",
...
class CfgEditorCategories {
  ...
  {
          displayName = "Insurrectionist (Green Horns)"; // Name visible in the
  list
  };*/
  ...
  */
  ...
  class c_rescue {
    displayName = "Colonial Rescue/Medical"; // Name visible in the list
  };
  class c_hazmat {
    displayName = "Colonial Hazmat"; // Name visible in the list
  };
  class c_firefighter {
    displayName = "Colonial Firefighters"; // Name visible in the list
  };
  class c_police_v {
    displayName = "Colonial Police Vehicles"; // Name visible in the list
  };
  class c_rescue_v {
    displayName =
        "Colonial Rescue/Medical Vehicles"; // Name visible in the list
  };
  class c_hazmat_v {
    displayName = "Colonial Hazmat Vehicles"; // Name visible in the list
  };
...
class CfgFactionClasses // This configures the in-game factions
{
  ...
  class ARMCO_C_Admin {
    dlc = "ARMCO OPTRE Reskins";
    displayName = "Colonial Administration";
    author = "Frosty & Mac";
    priority = 4;
    side = 2;
