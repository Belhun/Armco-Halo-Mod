...
class CfgEditorCategories {
	...
	{
		displayName = "Insurrectionist (Green Horns)"; // Name visible in the list
	};*/
	class colonial_administration // Category class, you point to it in editorCategory property
	{
...
class CfgEditorSubcategories {
	...
	*/
	...
	class c_rescue_v
	{
		displayName = "Colonial Rescue/Medical Vehicles"; // Name visible in the list
	};
	class c_hazmat_v
	{
