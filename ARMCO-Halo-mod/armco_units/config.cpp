class cfgPatches {
  class ARMCO_Armco_Faction {
    ...
    weapons[] = {"ARMCO_OPTRE_MA37GL",
                 ...
                 "ARMCO_OPTRE_M73"};
    requiredVersion = 0.1;
    requiredAddons[] = {"ace_captives",       "ace_hearing",
                        "ace_trenches",       "ace_huntir",
                        "ace_attach",         "ace_maptools",
                        "ace_rangecard",      "ace_medical_treatment",
                        "kat_pharma",         "kat_breathing",
                        "A3_Weapons_F",       "tfar_handhelds",
                        "OPTRE_Weapons_AR",   "OPTRE_Weapons_Pistol",
                        "CA_ARMCO_INFANTRY",  "OPTRE_Weapons_Items",
                        "kat_circulation",    "kat_surgery",
                        "ace_flashlights",    "ace_tagging",
                        "A3_Weapons_F_Items", "OPTRE_Weapons_Rockets",
                        "OPTRE_Weapons_DMR",  "OPTRE_Weapons_Sniper",
                        "OPTRE_Weapons_MG",   "OPTRE_UNSC_Units"};
  };
};
...
class cfgVehicles {
  ...
  class ARMCO_Alpha_Special_Weapons_Operator
  ...
  class ARMCO_Sabre_Special_Weapons_Operator
      : OPTRE_UNSC_Marine_Soldier_Unarmed {
    faction = "ARMCO_Armco_Faction";
    side = 1;
  ...
  class ARMCO_Zulu_Special_Weapons_Operator
      : OPTRE_UNSC_Marine_Soldier_Unarmed {
    faction = "ARMCO_Armco_Faction";
    side = 1;
