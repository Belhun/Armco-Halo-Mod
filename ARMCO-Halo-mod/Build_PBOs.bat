...
PBOConsole.exe -pack %~dp0custom_dress_uniforms %~dp0..\..\Export\@armcohalo\Addons\custom_dress_uniforms.pbo
...
PBOConsole.exe -pack %~dp0armoc_items           %~dp0..\..\Export\@armcohalo\Addons\armoc_items.pbo
