...
def main():
  ...
  This script will create two hard links on your system, both pointing to your Halo Retexture project folder:
    [Arma 3 installation directory]\\{} => Halo Retexture project folder
    P:\\{}                              => Halo Retexture project folder
