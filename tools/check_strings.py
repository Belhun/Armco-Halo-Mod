...
def getDefinedStrings(filepath):
    ...
    with open(filepath, 'r', encoding="latin-1") as file:
        content = file.read()
        srch = re.compile('Key ID\=\"(STR_AHR_[_a-zA-Z0-9]*)"', re.IGNORECASE)
...
def main(argv):
    ...
    if ("str_AHR_tagging_name" in allUsedStrings): allUsedStrings.remove("str_AHR_tagging_name") # Handle tagging macro
