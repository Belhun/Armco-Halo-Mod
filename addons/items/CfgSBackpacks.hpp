...
class ARMCO_Rucksack_Hard_Alpha : OPTRE_ILCS_Rucksack_Black {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_hard_alpha_co.paa)
	};
	  // TFAR Config
...
class ARMCO_Rucksack_Hard_Sabre : ARMCO_Rucksack_Hard_Alpha {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_hard_sabre_co.paa)
	};
};
class ARMCO_Rucksack_Hard_Zulu : ARMCO_Rucksack_Hard_Alpha {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_hard_zulu_co.paa)
	};
};
class ARMCO_Rucksack_Hard_Phoenix : ARMCO_Rucksack_Hard_Alpha {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_hard_phoenix_co.paa)
	};
};
class ARMCO_Rucksack_Hard_Medical : ARMCO_Rucksack_Hard_Alpha {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_hard_medical_co.paa)
	};
};
...
class ARMCO_Rucksack_Soft_Alpha : OPTRE_UNSC_Rucksack_Heavy {
	...
	hiddenSelections[] = {
		"camo", "camo2", "B_Medic", "B_Radio"
	};
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_soft_alpha_co.paa), ""
	};
};
class ARMCO_Rucksack_Soft_Sabre : OPTRE_UNSC_Rucksack_Heavy {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_soft_sabre_co.paa), ""
	};
};
class ARMCO_Rucksack_Soft_Zulu : OPTRE_UNSC_Rucksack_Heavy {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_soft_zulu_co.paa), ""
	};
};
class ARMCO_Rucksack_Soft_Phoenix : OPTRE_UNSC_Rucksack_Heavy {
	...
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_soft_phoenix_co.paa), ""
	};
};
class ARMCO_Rucksack_Soft_Medical : OPTRE_UNSC_Rucksack_Heavy {
	...
	hiddenSelections[] = {
		"camo", "camo2", "B_Addons", "B_Radio"
	};
	hiddenSelectionsTextures[] = {
		QPATHTOF(data\backpacks\backpack_odst_soft_medical_co.paa), ""
	};
};
