...
switch true do {
	...
	case (_veh isKindOf "ARMCO_M12_LRV") : {
		_veh attachTo [_pelican,[0,-4.5,0]];
		_loaded = true;
	};
	case (_veh isKindOf "ARMCO_M12G1_LRV") : {
		_veh attachTo [_pelican,[0,-4.5,0]];
		_loaded = true;
	};
	case (_veh isKindOf "ARMCO_M12A1_LRV") : {
		_veh attachTo [_pelican,[0,-4.5,-0]];
		_loaded = true;
	};
	case (_veh isKindOf "ARMCO_M12R_AA") : {
		_veh attachTo [_pelican,[0,-4.5,0]];
		_loaded = true;
	};
	case (_veh isKindOf "ARMCO_M12_FAV") : {
		_veh attachTo [_pelican,[0,-4.5,0]];
		_loaded = true;
	};
	case (_veh isKindOf "ARMCO_M12_FAV_APC") : {
		_veh attachTo [_pelican,[0,-4.5,0]];
		_loaded = true;
	};
	case (_veh isKindOf "ARMCO_M12_FAV_APC_MED") : {
		_veh attachTo [_pelican,[0,-4.5,0]];
		_loaded = true;
	};
	case (_veh isKindOf "ARMCO_M813_TT") : {
		_veh attachTo [_pelican,[0,-4.5,0]];
		_loaded = true;
	};
