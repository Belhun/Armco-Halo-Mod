	...
	class ARMCO_Pelican_Base_U : ARMCO_Pelican_Base_T
	{
		...
		class UserActions: UserActions
		{
			...
			class PelLift_OpenDetachPodMenu
			{
				...
				priority=3;
				onlyForPlayer=0;
				condition="(player in [gunner this, driver this]) and (({
					_x isKindOf ""OPTRE_Ammo_SupplyPod_Empty""
				} count (this getVariable [""OPTRE_Pelican_AttachedToVehiclesEffect"", []])) > 0)";
