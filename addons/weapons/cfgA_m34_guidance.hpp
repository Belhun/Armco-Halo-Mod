//Guidance for the M34 SSR HAV / HMW-34 Sturmhammer
        ...
        class ace_missileguidance {
            ...
            minDeflection = 0.001*2;      //0         // Minium flap deflection for guidance
            maxDeflection = 0.001*3;      //0.0027    // Maximum flap deflection for guidance
            incDeflection = 0.001*1.5;    //0.0005    // The incrmeent in which deflection adjusts.
